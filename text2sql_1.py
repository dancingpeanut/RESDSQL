...
def _test(opt):
    ...
    for batch in tqdm(dev_dataloder):
        ...
        t0 = time.time()
        # batch_inputs = ['请查询货物总数量? | 货物信息 : 货物信息.货物信息id , 货物信息.货物id , 货物信息.货物名称 , 货物信息.货物产地 , 货物信息.货物购买价 , 货物信息.货物品类 , 货物信息.供货公司, 货物信息.货物数量, 货物信息.货物售后负责人, 货物信息.货物售后负责人联系电话, 货物信息.货物公司销售负责人, 货物信息.货物公司负责人联系电话, 货物信息. * ']
        batch_inputs = ['请查询各道路的交通秩序的案件数量? （value "交通秩序" in `问题分类` column） | 交管案件数据_城区 : 交管案件数据_城区.申请时间 , 交管案件数据_城区.当事人电话 , 交管案件数据_城区.问题内容 , 交管案件数据_城区.问题分类1 , 交管案件数据_城区.问题分类 , 交管案件数据_城区.来源分类 , 交管案件数据_城区.问题分类2 , 交管案件数据_城区.行政区划 , 交管案件数据_城区.流程时间 , 交管案件数据_城区.案件地点 , 交管案件数据_城区.道路名称 , 交管案件数据_城区.处理人单位 , 交管案件数据_城区.路段代码 , 交管案件数据_城区.主键 , 交管案件数据_城区.行政区划 , 交管案件数据_城区.周 , 交管案件数据_城区.时 , 交管案件数据_城区.*']
        batch_db_ids = ['my_kk']
        batch_tc_original = [["交管案件数据_城区.申请时间", "交管案件数据_城区.当事人电话", "交管案件数据_城区.问题内容", "交管案件数据_城区.问题分类1", "交管案件数据_城区.问题分类", "交管案件数据_城区.来源分类", "交管案件数据_城区.问题分类2", "交管案件数据_城区.行政区划", "交管案件数据_城区.流程时间", "交管案件数据_城区.案件地点", "交管案件数据_城区.道路名称", "交管案件数据_城区.处理人单位", "交管案件数据_城区.路段代码", "交管案件数据_城区.主键", "交管案件数据_城区.周", "交管案件数据_城区.时", "交管案件数据_城区.*"]]
        table_dict = {}
